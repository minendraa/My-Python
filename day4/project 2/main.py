    ...
    for x in range(i):
        ...
        if (os.path.exists(filename))==False:
            ...
            with open(filename,mode='w',newline='')as file:
                ...
                writer.writerow(["Name, Roll number, Phonenumber, Address, Marks in C, Marks in C++, Marks in java, Marks in python, Average Marks Obtained, Grade"])
                writer.writerow([name,rollno,phonenumber,address,subject1,subject2,subject3,subject4,average_marks_obtained,Grade])
